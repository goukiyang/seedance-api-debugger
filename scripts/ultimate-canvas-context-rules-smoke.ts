...
assert.match(indexSource, /styles\.css\?v=20260620-rules-visible/);
assert.match(indexSource, /canvas-engine\.js\?v=20260620-rules-visible/);
assert.match(indexSource, /app\.js\?v=20260620-rules-visible/);
