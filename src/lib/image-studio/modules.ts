...
async function moduleDTO(row: { id: string; name: string; prompt: string; context: string; count: number; aspect_ratio?: string; reference_ids: string; revision: number; created_at: Date; updated_at: Date }, ownerId: string, saved = true, isAdmin = false) {
